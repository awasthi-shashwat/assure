...
INSERT INTO MEMBERS(MEMBER_ID,DOB,CITY,EMAIL,GENDER,HEIGHT,IS_TAKING_MEDICINES,MARTIAL_STATUS,MOBILE,NAME,OCCUPATION,RELATION_WITH_USER,WEIGHT,POLICY_BOOKINGS_BOOKING_ID) VALUES(1,'11/02/1996','PTK','ABC@GMAIL.COM','MALE','5ft',TRUE,'UNMARRIED','9888422255','ABHI','SELF-EMPLOYED','Brother','60KG',NULL);
...
INSERT INTO POLICY_BOOKINGS VALUES (1, '2021-11-10 16:48:18.434', 100000.0, 3, 'MAX BUPA', 19000.0, 1, 1);
